...
load mood_factor_positive; %全是正的学术情绪
load mood_factor_negative %全是负的学术情绪
load mood_factor_negativ_positive %完全随机没规律的情绪波动
load regularly_fluctuating %有规律的情绪波动
load from_hign_to_low %学术情绪从正到负
load from_low_to_high %学术情绪从负到正
mood_factor=mood_factor_positive;
...
%     middle_reference_difficulty=final_negotiation_value*compute_max_value;
    a=1.505;
    b=-0.774;
    mood_factor_now=mood_factor(i,1);
...
%         c_max_l=(c_max_h+c_min_l)/2+(c_max_h-c_min_l)/8;
         ...
         a=1.505;
         b=-0.774;
         mood_factor_now=mood_factor(i,change_num);%change_num
         mood_factor_now=a/(1+exp(-mood_factor_now))+b;
         middle_reference_difficulty=final_negotiation_value*compute_max_value;
         middle_reference_difficulty=(1+mood_factor_now)*middle_reference_difficulty;
